...
import render_dual_tongue_comparison as rd
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument(
        "--beat-root",
        default="/home/iite/ICT-FaceKit/data/beat_cache/beat_english_v0.2.1/beat_english_v0.2.1",
        help="Root containing per-speaker folders",
    )
    p.add_argument("--motion-path", required=True, help="Path to EMA .npy")
    p.add_argument(
        "--output-dir",
        default="/home/iite/ICT-FaceKit/tongue_scripts/outputs/multi_speaker",
    )
