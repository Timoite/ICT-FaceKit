...
class ICTFaceAnimationRenderer:
    ...
    def render_animation(self, anim_data, output_dir=None,
        ...
        if output_dir is None:
            output_dir = PROJECT_ROOT / 'sample_data_out' / 'rendered_frames'
    ...
    def export_video(self, rendered_data, output_path=None, fps=60):
        """
        ...
        if output_path is None:
            output_path = PROJECT_ROOT / 'sample_data_out' / 'face_animation.mp4'
...
def main():
    ...
    # Initialize renderer
    renderer = ICTFaceAnimationRenderer()

    # Load animation data
    anim_path = PROJECT_ROOT / 'data' / '26_reamey_0_1_1.json'
    anim_data = renderer.load_animation(anim_path)

    # Render animation at 60fps for smooth video (10 seconds worth)
    print("\nRendering animation for video export...")
    print("   Rendering at 60fps for 10 seconds (600 frames)...")
    ...
    validation_path = PROJECT_ROOT / 'sample_data_out' / 'phase1_validation.png'
    ...
    print(f"Validation image saved: '{validation_path}'")
