## Run: vocaset_sentence01_passive_vs_std0p27_z0p00_th1p40_ctc0p1_fresh | 2026-05-27 19:36:02

### Settings
- dataset id: `vocaset_FaceTalk_170725_00137_TA_sentence01`
- config: `configs/LRS3_V_WER19.1_ctc0.1.ini`
- infer mode: `full`
- vowel mode: `grouped`
- detector: `mediapipe`
...
|---|---:|---:|---:|---:|---:|---:|---:|
| vocaset_FaceTalk_170725_00137_TA_sentence01_passive_tongue_with_audio.mp4 | 0.6765 | 1.0000 | 1.0000 | 0.8382 | 32.35% | 0.00% | 10 |
| vocaset_FaceTalk_170725_00137_TA_sentence01_std0p27_z0p00_th1p40_active_tongue_with_audio.mp4 | 0.6765 | 1.0000 | 1.0000 | 0.8382 | 32.35% | 0.00% | 11 |

- Best (by composite): **vocaset_FaceTalk_170725_00137_TA_sentence01_passive_tongue_with_audio.mp4** (VER=0.6765, WER_norm=1.0000, Composite=0.8382)
- Worst (by composite): **vocaset_FaceTalk_170725_00137_TA_sentence01_std0p27_z0p00_th1p40_active_tongue_with_audio.mp4** (VER=0.6765, WER_norm=1.0000, Composite=0.8382)
...
- WER(norm): 1.0000
- WER(raw): 1.0000
- Composite Index: 0.8382
- Viseme Accuracy: 32.35%
- Word Accuracy(norm): 0.00%
- HYP: I JUST STARTED TO INCREASE THE POSH MARKET EARLY ON
...
- Viseme Accuracy: 32.35%
- Word Accuracy(norm): 0.00%
- HYP: YOU KNOW HOW TO START TO INCREASE THE BRUSH PRODUCT ALREADY
